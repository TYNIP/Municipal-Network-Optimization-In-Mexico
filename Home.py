...
st.set_page_config(page_title="Municipal Network Optimization In Mexico", layout="wide")
st.title("Municipal Network Optimization In Mexico")
...
st.markdown("""          
### Roadmap (6–18 months) — Three Phases

Roadmap for Implementation — 6–18 month
---
""")